...
!function(e, n) {
  ...
  function r(t, i) {
    var a = t.getBoundingClientRect(), u = a.top, c = a.bottom, f = a.left, l = a.right, d = e.extend({tolerance:0, viewport:n}, i), s = !1, p = d.viewport.jquery ? d.viewport : e(d.viewport);
  ...
  function i(n) {
    if (n) {
      var t = n.split(",");
      return 1 === t.length && isNaN(t[0]) && (t[1] = t[0], t[0] = void 0), {tolerance:t[0] ? t[0].trim() : void 0, viewport:t[1] ? e(t[1].trim()) : void 0};
    }
    return {};
  }
  e = "default" in e ? e["default"] : e, n = "default" in n ? n["default"] : n, e.extend(e.expr[":"], {"in-viewport":e.expr.createPseudo ? e.expr.createPseudo(function(e) {
    return function(n) {
      return r(n, i(e));
    };
  }) : function(e, n, t) {
