...
[^1]: Footnotes are the mind killer. This is the first paragraph.

    This paragraph is inside the note. 
    It looks better if the whole paragraph is indented, but it isn't required. The first line is enough.
