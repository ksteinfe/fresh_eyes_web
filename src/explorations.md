...
![vid||loop controls muted](https://berkeley.box.com/shared/static/gk73knkd3tj00lhnwvgoxp5izveelmus.gif "We then used two different strategies to turn these points back into masses. The first involved creating a mesh around previously filtered points based on a charge given to each of them using the Cocoon plug-in.")


[[section|slide]]

![vid||loop controls muted](https://berkeley.box.com/shared/static/5asv0yzwix0yq4cp908hw1oo8p1l0js5.gif "The second strategy was to determine a linear boundary for each Z level associated with each vertical pixel of the ML elevation and then extrude them by a distance equal to height of the pixel is standing for.")
