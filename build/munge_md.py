                ...
                if "|" in alt_text:
                    ...
                    if args[0] == "scroll":
                        ...
                        try:
                            ...
                            ht = '<figure><div class="scroll-wrapper" style="height: {3}px"><div style="margin: auto; width: {1}px; height: {2}px;  background: url({0}) repeat 0 0; background-position: 0 -{2}px; -webkit-animation: background-scroller {4}s linear infinite;"></div><figcaption>{5}</figcaption></figure>'
