                ...
                if "|" in alt_text:
                    ...
                    if args[0] == "scroll":
                        ...
                        try:
                            ...
                            ht = '<figure class="scrolling" style="height: {3}px"><figcaption>{5}</figcaption><div style="margin: auto; width: {1}px; height: {2}px;  background: url({0}) repeat 0 0; background-position: 0 -{2}px; -webkit-animation: background-scroller {4}s linear infinite;"></div></figure>'
